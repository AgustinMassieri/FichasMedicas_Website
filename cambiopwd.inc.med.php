...
if($pwdNueva==$pwdNuevaVer){
	...
	if($resultCheckpwd>0){
		...
		header("Location: privacidadMed.php?changepwd=succesful");
	  
	}
	else{
		header("Location: privacidadMed.php?changepwd=ogpwderror");
	}
}
else{
	header("Location: privacidadMed.php?changepwd=newpwderror"); 
